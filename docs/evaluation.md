...
Current release lineage is tracked in [release-v1.7.0.md](release-v1.7.0.md), while the reusable release gates and remaining boundaries live in [release-checklist.md](release-checklist.md). Update both before a release tag or marketplace submission.
